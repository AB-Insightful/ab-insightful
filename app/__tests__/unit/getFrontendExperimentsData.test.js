        ...
        variants: [
          {
            id: 10,
            name: "Control",
            configData: { sectionId: "c1" },
            trafficAllocation: "0.5",
          },
          {
            id: 11,
            name: "Variant A",
            configData: { sectionId: "a1" },
            trafficAllocation: "0.5",
          },
        ],
      },
        ...
        variants: [
          {
            id: 20,
            name: "Control",
            configData: { sectionId: "c2" },
            trafficAllocation: "0.34",
          },
          {
            id: 21,
            name: "Variant A",
            configData: { sectionId: "a2" },
            trafficAllocation: "0.33",
          },
          {
            id: 22,
            name: "Variant B",
            configData: { sectionId: "b2" },
            trafficAllocation: "0.33",
          },
        ],
      },
