...
export default defineConfig({
  ...
  test: {
    ...
    include: [
      ...
      "src/**/*.test.{js,jsx}",
      "app/**/__tests__/unit/*.{js,jsx}",
    ],
    exclude: ["node_modules", "dist", "app/__tests__/integration/**.js"], // define directories to skip
    ...
    coverage: {
      ...
      exclude: [
        // define which files to not perform coverage on (all tests)
        "src/**/*.test.*",
        "src/**/__tests__/**",
        "src/setupTests.js",
      ],
