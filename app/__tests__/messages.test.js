...
const APP_URL_BASE = 'https://admin.shopify.com/store/test-store-for-ben/apps/ab-insightful-1/app';
...
describe('formatExperimentStarted', () => {
  ...
  it('email body contains the correct experiment URL', () => {
    expect(result.emailBody).toContain(`${APP_URL_BASE}/reports/${EXPERIMENT_ID}`);
  });
  ...
  it('SMS body contains the correct experiment URL', () => {
    expect(result.smsBody).toContain(`${APP_URL_BASE}/reports/${EXPERIMENT_ID}`);
  });
